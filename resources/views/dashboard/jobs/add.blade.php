      ...
      <div class="card">
        <div class="card-body">
          <h6 class="card-title">Post a New Job</h6>
           <form method="POST" action="{{ url('job/store') }}" class="forms-sample" enctype="multipart/form-data">
            @csrf
            <div class="row">
              <div class="form-group col-md-6">
                <label for="title">Title<span style="color:red;"> *</span></label>
                <input required type="text" class="form-control" id="title" name="title" autocomplete="off" placeholder="UI/UX Designer">
              </div>
              <div class="form-group col-md-6">
            ...
            <div class="row">
              <div class="form-group col-md-12">
                ...
                <textarea required class="form-control" placeholder="Enter Job Description" name="description" id="description" cols="30" rows="5"></textarea>
              </div>
            </div>
                    ...
                    <label for="role">Key Responsibilities<span style="color:red;"> *</span></label>
                        <div class="table-responsive pt-1"  style="overflow-x: clip !important;">
                          <table class="table table-bordered summary">
                            ...
                            <tbody>
                                <tr style="width:50px;" class="row_1">
                                  <td>
                                    <input class="form-control" type="text" name="responsibility_name[]">
                                      <div class="text-right mt-0" onclick="remove(1)"><button style="margin-top: -10%;" type="button" class="remove_activity btn btn-danger btn-icon">
