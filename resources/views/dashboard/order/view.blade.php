                ...
                <tr @if ($order->notify_paid == '1' || $order->notify_complete == '1') style="background-color:#F2F3F4;" @endif>
                  ...
                  <td class="text-center">
                      @can('Download Order Invoice')
                        <a title="Invoice" href="{{ url('order/invoice/'.encrypt($order->id)) }}">
                      ...
                      @if ($order->notify_complete == '1' || $order->notify_paid == '1')
                      ...
                      <button type="button" class="btn btn-success"><a href="{{ url('order/items/'.encrypt($order->id)) }}"></a>Order Details</button>
                      @endcan
                  </td>
                </tr>
                @endforeach
